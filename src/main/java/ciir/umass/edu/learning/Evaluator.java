...
public class Evaluator {
	...
	public static void main(String[] args) {
		...
		if(args.length < 2)
		{
			...
			System.out.println("\t[ -metric2T <metric> ]\tMetric to evaluate on the test data (default to the same as specified for -metric2t). Metrics available are one provided by metric2t, and also supported for testing is WTA (Winner Takes All)");
